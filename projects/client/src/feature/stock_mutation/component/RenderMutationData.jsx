  ...
  return dataList?.map((data) => {
    ...
    return (
      <div
        ...
        className="row-span-1 font-normal grid lg:grid-cols-9 text-primary
      ...
      >
        ...
        <p className="col-span-2 lg:col-span-2 text-center">{cutString(data.product_name)}</p>
        ...
        <p className="hidden lg:inline lg:col-span-2 lg:text-center">{new Date(data.updatedAt).toLocaleString()}</p>
      </div>
    );
  });
}
